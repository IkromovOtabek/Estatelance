...
export default function AdminTargetsSection({ tab, onTabChange }: AdminTargetsSectionProps) {
  ...
  return (
    <div>
      ...
      <div className="flex flex-wrap items-center gap-2 mb-6 border-b border-slate-200 dark:border-[#16161F] pb-3">
            ...
            <button
              ...
              className={`inline-flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-semibold transition-colors ${
                active
                  ...
                  : 'text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-[#16161F]'
              }`}
            >
